...
android {
    namespace = "uk.co.cabcomply.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "uk.co.cabcomply.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Security (PIN storage)
    implementation("androidx.security:security-crypto:1.1.0-alpha06")

    // EXIF orientation handling for imported/captured photos
    implementation("androidx.exifinterface:exifinterface:1.3.7")

    // Billing
    implementation("com.android.billingclient:billing-ktx:6.2.1")

    // Coil (image loading for photos/thumbnails)
    implementation("io.coil-kt:coil-compose:2.7.0")

    // JSON for the local backup/restore format
